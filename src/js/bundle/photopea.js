...
function PhotopeaApp() {
	...
	this.d = {
		...
		L7: [],
		keys: [KeyboardHandler.AR, KeyboardHandler.dQ, KeyboardHandler.Hm, KeyboardHandler.p6, KeyboardHandler.nA, KeyboardHandler.wo, KeyboardHandler.Ns, KeyboardHandler.Zt, KeyboardHandler.kC, KeyboardHandler.E, KeyboardHandler.Jv, null, KeyboardHandler.vc, KeyboardHandler.hD, KeyboardHandler.Ho, KeyboardHandler.$, KeyboardHandler.fu, KeyboardHandler.Zi, KeyboardHandler.dr],
		Vi: [
